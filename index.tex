...
% ========================================================================================================
\chapter{V + zu + V - два глагола в предложении}
...
% ========================================================================================================
\chapter{V + um + zu + V - что-бы}

Тоже самое что V + zu, но смысл "что бы". Всё тоже самое, только перед придаточным предложением помещается \term{um}.

\paragraph{Примеры:}
\begin{itemize}
\item Ich gehe zu shule \term{um} neue kentnise zubekommen.
